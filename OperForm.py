...
class Ui_OperatorForm(object):
    ...
    def setupUi(self, OperatorForm):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("GUI\\../Pictures/calculate.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("GUI\\../Pictures/add.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.CheckConverter.setEnabled(False)
        self.CheckConverter.setGeometry(QtCore.QRect(260, 20, 31, 21))
        self.CheckConverter.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("GUI\\../Pictures/testing.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("GUI\\../Pictures/remove.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.RemoveFluxeButton.setIcon(icon4)
        ...
        self.SlagWeight.setEnabled(True)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("Pictures/calculate.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.NextSteel.setEnabled(True)
